...
\newcolumntype{\laszTabColJdg}[1]{>{\columncolor[gray]{#1}[\tabcolsep][0pt]} r}
\newcolumntype{\laszTabColWOr}[1]{>{\columncolor[gray]{#1}[0pt][\tabcolsep]} l}
\newcommand{\laszTabColA}{0.85}
\newcommand{\laszTabColB}{0.95}
\newcommand{\laszTabColC}{0.85}
