...
\todo[inline]{Please filter this list and delete items already defined in the Leipzig Glossing Rules. It's OK to have different abbreviations than those in the LGR.}
\begin{multicols}{2}
\begin{tabbing}
