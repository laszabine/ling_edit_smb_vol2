...
\ea
  \gll {Wenn} {du} {auch nur} {ein} {einziges} {Stück} {von} {dieser} {Torte} {kostest,} {\{{wirst} /} {würdest}\} {du} {sehen,} {dass} {sie} {irgendwie} {doch} {gut} {schmeckt.}\\
...
notes that \citegen{zwarts1990} notion of anti-additiveness is too strict, given that examples with ``extreme'' items
...
formulates a “viability constraint on alternatives”, aligning her analysis to \citegen{chierchia2011}
...
\ea
  \gll {Wenige Wähler} {haben} {auch nur irgendein} {Buch} {gelesen.}\\
...
\begin{exe}
  \judgewidth{??}
  \ex[??]{
    \gll {Gustav ist größer als} {auch nur} {irgendeiner} {von seinen Kollegen.}\\
         {Gustav is taller than} {even} {anyone} {of his colleagues}\\
    \trans `Gustav is taller than \emph{any} of his colleagues.'
  }
\end{exe}
