...
\author{Martin Prinzhorn\affiliation{University of Vienna}\lastand Viola Schmitt\affiliation{Humboldt University Berlin}\orcid{}}
...
\newcommand{\sem}[2]{\mbox{$[\![${#2}$]\!]^{#1}$}} %Semantik
...
\ea  
\ea  {\it The children / $\#$ Ada assembled in the hall.} \label{prinzhornex1a}
\ex	{\it Ada wanted to assemble in the hall.} \hfill \cite[(1a)]{Pearson:2016} \label{prinzhornex1b}
\ex	  {\it The children / $\#$ Ada went on vacation together.} \label{prinzhornex2a}
\ex 	{\it Ada expected to go on vacation together.} \hfill \cite[(1a)]{Pearson:2016} \label{prinzhornex2b}
\z\z
...
\ea	 {\it The children / $\#$ Ada will meet each other at 6 today.}
\ex	{\it The children / $\#$ Ada each donated at least $\$$ 100.}
\z\z
...
\ea {\bf EP-restriction (German)}:  The EP in PC cannot contain overt distributivity operators or reciprocals and prohibits a cumulative reading of an embedded plurality relative to the subject of the embedded clause. \label{prinzhornex-ep} \z
...
\ea {\it Ada intends to go on vacation together} \label{prinzhornex32a}
...
\ea \footnotesize \Tree [.{$[f(a)+g(b), f(b)+g(a), f(a)+g(a)+g(b), f(b)+g(a)+g(b), f(a)+f(b)+g(a), f(a)+f(b)+g(b),$\\$f(a)+f(b)+g(a)+g(b)]$} {$[f+g]$ }   {$[a+b]$} ] \label{prinzhornpp2} \z
...
\ea \footnotesize \Tree [.{$[meet(a+b)]]$} {$[meet]$ }   {$[a+b]$} ].  \Tree [.{$[meet(a+b),meet(a+c), meet(b+c), meet (a+b+c)]$} {$[meet]$ }   {$[a+b+c]$} ]  \label{prinzhornpp4} \z
